...
import { Container, HStack, Item, Input, Icon, Button, IconButton } from 'native-base';
    ...
    return (
        <Container style={{ backgroundColor: '#fff' }} >
            <HStack px="1" py="3" justifyContent="space-between" alignItems="center" w="100%" maxW="350">
                ...
                <HStack>
                    <IconButton icon={<Icon name="ios-search" />} />
                    <IconButton icon={<Icon name="people" />} />
                </HStack> */}
            </HStack>
            {/* <HStack style={{ backgroundColor: Colors.brightBlue }} searchBar rounded>
                <Item>
